...
```
"""
struct GrossPitaevskiiProblem{N,M,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10}
    u0::NTuple{M,T1}
    lengths::NTuple{N,T2}
    dispersion::T3
    potential::T4
    nonlinearity::T5
    pump::T6
    position_noise_func::T7
    momentum_noise_func::T8
    noise_prototype::T9
    param::T10
    function GrossPitaevskiiProblem(u0::Tuple, lengths::Tuple; dispersion::T3=additiveIdentity, potential::T4=additiveIdentity,
        nonlinearity::T5=additiveIdentity, pump::T6=additiveIdentity,
        position_noise_func::T7=additiveIdentity, momentum_noise_func::T8=additiveIdentity, noise_prototype::T9=additiveIdentity,
        param::T10=nothing) where {T3,T4,T5,T6,T7,T8,T9,T10}
        ...
        new{N,M,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10}(_u0, _lengths, dispersion, potential, nonlinearity,
            pump, position_noise_func, momentum_noise_func, noise_prototype, param)
    end
end
